...
import com.fruitland.fruitland.activity.Select_Customer;
import com.fruitland.fruitland.model.Customer_Bean;

import java.util.ArrayList;

public class SelectCustomer_RecycleAddAdapter extends RecyclerView.Adapter<SelectCustomer_RecycleAddAdapter.MyViewHolder> {


    private Context mContext;
    private ArrayList<Customer_Bean> mValues;
    Select_Customer add_delivery;
    ...
    public SelectCustomer_RecycleAddAdapter(Context context, ArrayList<Customer_Bean> list, Select_Customer add_delivery) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        if (hm.getChecked() == 1) {
            add_delivery.addItems(Integer.parseInt(hm.getCustomer_id()),hm.getContact());
